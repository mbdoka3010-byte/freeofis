...
export const ROLE_TEMPLATES = Object.freeze([
  ...
  { code: 'manager', name: 'Manager', permissionCodes: ['organisation.view', 'units.view', 'units.manage', 'memberships.view', 'workspaces.view', 'workspaces.activate'] },
  { code: 'member', name: 'Member', permissionCodes: ['organisation.view', 'units.view', 'workspaces.view'] }
