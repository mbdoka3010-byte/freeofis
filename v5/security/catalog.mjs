...
export const ROLE_TEMPLATES = Object.freeze([
  ...
  { code: 'manager', name: 'Manager', permissionCodes: ['organisation.view', 'units.view', 'units.manage', 'memberships.view', 'workspaces.view', 'workspaces.activate','office.view','office.work','office.correspondence','office.meetings','office.records','office.confidential.view','school.view','school.learn','school.teach','school.results','school.fees'] },
  { code: 'member', name: 'Member', permissionCodes: ['organisation.view', 'units.view', 'workspaces.view','office.view','office.work','school.view','school.learn'] }
