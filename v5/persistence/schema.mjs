...
export const V5_DATABASE_VERSION = 1;
export const V5_STORES = Object.freeze({ meta: 'meta', users: 'users', personalEnvironments: 'personalEnvironments', organisations: 'organisations', organisationUnits: 'organisationUnits', memberships: 'memberships', roles: 'roles', roleAssignments: 'roleAssignments', workspaceDefinitions: 'workspaceDefinitions', workspaceInstances: 'workspaceInstances', activityEvents: 'activityEvents', auditEvents: 'auditEvents', sessions: 'sessions' });
